...
#ifndef __BigWinner__SpCurrency__
#define __BigWinner__SpCurrency__
...
class SpCurrency : public CCLayerColor, public CCTableViewDataSource, public CCTableViewDelegate
{
public:
    SpCurrency()
    {
...
#endif /* defined(__BigWinner__SpCurrency__) */
